        ...
        public static void Initialize(PoTrackerDbContext context)
        {
            ...
            tzSupplier.AddProducts(
                new List<Product>
                {
                    ...
                    new Product("11882", "GBC Pre-Punched Binding Paper, Plastic, White, 8-1/2\" x 11\"", tzbinderCategory, 15.99m),
                    ...
                    new Product("13596", "Hanging Personal Folder File", tzstorageCategory, 15.7m),
                    new Product("14070", "Fellowes Black Plastic Comb Bindings", tzbinderCategory, 5.81m),
                    ...
                    new Product("20209", "Xerox 1982", tzpaperCategory, 22.84m),
                    ...
                    new Product("22414", "GBC Binding covers", tzbinderCategory, 12.95m),
                    new Product("22775", "Newell 323", tzpensCategory, 1.68m),
                    ...
                    new Product("24220", "Newell 323", tzpensCategory, 1.68m),
                    ...
                    new Product("27363", "Peel & Seel® Recycled Catalog Envelopes, Brown", tzenvelopeCategory, 11.58m),
                    new Product("27364", "Avery 506", tzlabelCategory, 4.13m),
                    new Product("27397", "Prang Drawing Pencil Set", tzpensCategory, 2.78m),
                    ...
                    new Product("30286", "3M Organizer Strips", tzbinderCategory, 5.4m),
                    ...
                    new Product("31971", "Poly Designer Cover & Back", tzbinderCategory, 18.99m),
                    ...
                    new Product("33105", "Prismacolor Color Pencil Set", tzpensCategory, 19.84m),
                    ...
                    new Product("35765", "Deluxe Rollaway Locking File with Drawer", tzstorageCategory, 415.88m),
                    new Product("35798", "*Staples* vLetter Openers, 2/Pack", tzscissorsCategory, 3.68m),
                    new Product("35903", "Staples 6 Outlet Surge", tzappCategory, 11.97m),
                    ...
                    new Product("38442", "Acco Perma® 2700 Stacking Storage Drawers", tzstorageCategory, 29.74m),
                    ...
                    new Product("38981", "Self-Adhesive Address Labels for Typewriters by Universal", tzlabelCategory, 7.31m),
                    ...
                    new Product("42818", "Carina Double Wide Media Storage Towers in Natural & Black", tzstorageCategory, 80.98m),
                    new Product("42920", "Portable Personal File Box", tzstorageCategory, 12.21m),
                    ...
                    new Product("44924", "Fellowes PB500 Electric Punch Plastic Comb Binding Machine with Manual Bind", tzbinderCategory, 1270.99m),
            ...
            fmSupplier.AddProducts(
                new List<Product>
                {
                    ...
                    new Product("58560", "SAFCO PlanMaster Heigh-Adjustable Drafting Table Base, 43w x 30d x 30-37h, Black", fmtablesCategory, 349.45m),
                    ...
                    new Product("15162", "Tensor \"Hersey Kiss\" Styled Floor Lamp", fmofficeFurnCategory, 12.99m),
                    new Product("23688", "DAX Copper Panel Document Frame, 5 x 7 Size", fmofficeFurnCategory, 12.58m),
                    ...
                    new Product("24683", "Howard Miller 12-3/4 Diameter Accuwave DS ™ Wall Clock", fmofficeFurnCategory, 78.69m),
                    ...
                    new Product("42565", "Linden® 12\" Wall Clock With Oak Frame", fmofficeFurnCategory, 33.98m),
                    ...
                    new Product("61712", "Eldon® Wave Desk Accessories", fmofficeFurnCategory, 2.08m),
                    ...
                    new Product("524", "Eldon® Expressions™ Wood Desk Accessories, Oak", fmofficeFurnCategory, 7.38m)
                });
            ...
            oSupplier.AddProducts(
                new List<Product>
                {
                    ...
                    new Product("47581", "Xerox 1927", opaperCategory, 4.28m),
                    ...
                    new Product("9616", "3M Organizer Strips", obinderCategory, 5.4m),
                    new Product("9903", "Cardinal Poly Pocket Divider Pockets for Ring Binders", obinderCategory, 3.36m),
                    ...
                    new Product("11660", "Xerox 1952", opaperCategory, 4.98m),
                    ...
                    new Product("13477", "Xerox 1940", opaperCategory, 54.96m),
                    ...
                    new Product("13956", "Bravo II™ Megaboss® 12-Amp Hard Body Upright, Replacement Belts, 2 Belts per Pack", oappCategory, 3.25m)
                });
