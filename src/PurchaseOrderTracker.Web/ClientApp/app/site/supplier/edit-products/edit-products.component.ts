...
export class EditProductsComponent implements OnInit {
    ...
    refreshData(resetPageNumber?: boolean, productFilter?: string): void {
        if (resetPageNumber) this.pageNumber = this.defaultPageNumber;
        let query = new EditProductsQuery(this.supplierId, this.pageNumber, productFilter);
    ...
    onDeleteProduct(productIndex: number): void {
        let product = this.model.items[productIndex];
        let command = new DeleteCommand(this.supplierId, product.productId);
    ...
    onSubmitEditProduct(productIndex: number): void {
        let product = this.model.items[productIndex];
        let command = this.buildEditProductCommand(product);
