...
export class EditComponent implements OnInit {
    ...
    refreshData(): void {
        let query = new EditQuery(this.purchaseOrderId);
    ...
    onSubmit() {
        let command = new EditCommand(this.purchaseOrderId, this.model.orderNo, this.model.supplierId, this.model.shipmentId);
    ...
    onDelete() {
        let command = new DeleteCommand(this.purchaseOrderId);
